      ...
      <div className="flex-1 bg-white flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-neutral-900 mb-2 font-inter">Log in</h1>
          </div>

          <div className="space-y-4 mb-6">
            {/* Social Login Buttons */}
            <button className="w-full flex items-center justify-center gap-3 border border-neutral-200 rounded-lg px-4 py-3 hover:bg-neutral-50 transition-colors">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <input
                ...
                className="w-full px-4 py-3 border border-neutral-200 rounded-lg focus:ring-2 focus:ring-brand-blue focus:border-brand-blue transition-colors"
                required
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-brand-blue hover:bg-blue-600 text-white py-3 px-4 rounded-lg font-medium transition-colors"
            >
              Log In
            </button>
          </form>
